let jobs = [
  {
    ...
    addres: "Remote • Full-time • $130,000 - $175,000",
    status: "NOT APPLIED",
  ...
  },
  {
    ...
    addres: "Los Angeles, CA • Part-time • $80,000 - $120,000",
    status: "NOT APPLIED",
  ...
  },
  {
    ...
    addres: "Boston, MA • Full-time • $125,000 - $165,000",
    status: "NOT APPLIED",
  ...
  },
  {
    ...
    addres: "Seattle, WA • Full-time • $140,000 - $190,000",
    status: "NOT APPLIED",
  ...
  <div class="card bg-white border border-gray-200 rounded-2xl p-6 shadow-sm flex justify-between gap-6" data-id="${job.id}">
    <div class="space-y-4">
      <div>
        ...
        <p class="addres mt-2 text-xs text-gray-500">${job.addres}</p>
      </div>
